...
using HospitalMobileAPPApi.Services.Reports.Renderers;
...
builder.Services.AddScoped<IReportPdfRenderer, PrescriptionReportRenderer>();
builder.Services.AddScoped<IReportPdfRenderer, BillingReceiptRenderer>();
builder.Services.AddScoped<IReportPdfRenderer, DischargeCertificateRenderer>();
